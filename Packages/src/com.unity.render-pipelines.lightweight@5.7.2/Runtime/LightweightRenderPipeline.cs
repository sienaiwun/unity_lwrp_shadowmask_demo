    ...
    public sealed partial class LightweightRenderPipeline : RenderPipeline
    {
        ...
        static void SetSupportedRenderingFeatures()
        {
            ...
            SupportedRenderingFeatures.active = new SupportedRenderingFeatures()
            {
                ...
                mixedLightingModes = SupportedRenderingFeatures.LightmapMixedBakeModes.Subtractive | SupportedRenderingFeatures.LightmapMixedBakeModes.Shadowmask,
        ...
        {
            var configuration = PerObjectData.ReflectionProbes | PerObjectData.Lightmaps | PerObjectData.LightProbe | PerObjectData.LightData | PerObjectData.ShadowMask;
